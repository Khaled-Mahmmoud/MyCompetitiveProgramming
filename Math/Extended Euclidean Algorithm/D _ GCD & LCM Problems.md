...
Consider circular track with n points marked as 1, 2, …n. A person is initially placed on any point. The person moves m, slot forward (in circular way) in each step.
