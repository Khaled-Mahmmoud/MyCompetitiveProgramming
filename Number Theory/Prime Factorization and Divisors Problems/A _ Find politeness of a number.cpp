...
In general if a number can be represented as ap * bq * cr … where a, b, c, … are prime factors of n
...
How does above formula work? The fact is, if a number is expressed as ap * bq * cr … where a, b, c, … are prime factors of n
then number of divisors is (p+1)*(q+1)*(r+1) ……To simplify, let there be one factor and number is expressed as ap
Divisors are 1, a, a2, …. ap. The count of divisors is p+1
Now let us take a slightly more complicated case apbp. The divisors are :
1, a, a2, …. ap
b, ba, ba2, …. bap
b2, b2a, b2a2, …. b2ap
…………….
