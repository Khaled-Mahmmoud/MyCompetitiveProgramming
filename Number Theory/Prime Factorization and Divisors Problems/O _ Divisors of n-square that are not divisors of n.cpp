...
Given an positive large integer n. Count the number of positive divisors of n^2 which
are not divisors of n(1 <= n <= 10^12).

Input: 6
Output: 5
Explanation
Total divisors of 6^2 are 9 i.e.,
1, 2, 3, 4, 6, 9, 12, 18, 36
Total divisors of '6' are 4,
1, 2, 3, 6
Total divisor of '36' which are not divisors of n '6' are
'5' i.e., 4, 9, 12, 18, 36
